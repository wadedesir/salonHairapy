...
const shopgridpost = [
    { img: img1, title: 'Color( Full)', discount: '', price: 20 },
    { img: img2, title: 'Hilight(Full)', discount: '', price: 35 },
    { img: img3, title: 'Rinse/Gray/Perimeter', discount: '', price: 20 },

    { img: img1, title: 'Additional Batch', discount: '', price: 25 },
    { img: img2, title: 'Hilight (Half)', discount: '', price: 40 },
    { img: img3, title: '2X Process', discount: '', price: 20 },
