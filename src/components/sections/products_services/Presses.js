...
const shopgridpost = [
    ...
    { img: img2, title: 'Silk Press', discount: '', price: 35 },
    { img: img3, title: 'Curl', discount: '', price: 20 },

    { img: img1, title: 'press (Long)', discount: '', price: 25 },
    { img: img2, title: 'Silk Press (Long)', discount: '', price: 40 },
    { img: img3, title: 'Formal UpDo', discount: '', price: 20 },
