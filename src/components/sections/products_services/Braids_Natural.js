...
const shopgridpost = [
    { img: img1, title: 'Cornrows', discount: '', price: 20 },
    { img: img2, title: 'Designer(Big)', discount: '', price: 35 },
    { img: img3, title: 'Single (Big)', discount: '', price: 20 },

    { img: img1, title: 'Partial Single(Small)', discount: '', price: 25 },
    { img: img2, title: 'cornrow/Singles', discount: '', price: 40 },
    { img: img3, title: 'Beads', discount: '', price: 20 },

    { img: img1, title: 'Single (Medium)', discount: '', price: 40 },
    { img: img2, title: 'Single (Small)', discount: '', price: 10 },
    { img: img3, title: 'Designer(small)', discount: '', price: 15 },

    { img: img1, title: 'Partial (Single)', discount: '', price: 25 },
    { img: img2, title: 'Braid ADD-On', discount: '', price: 290 },
    { img: img3, title: 'Removal', discount: '', price: 450 },

    { img: img1, title: 'Designer(Medium)', discount: '', price: 25 },
    { img: img2, title: 'Braid ADD-On', discount: '', price: 290 },
    { img: img3, title: 'Removal', discount: '', price: 450 },
];
