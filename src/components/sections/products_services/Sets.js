...
const shopgridpost = [
    { img: img1, title: 'Wash and Set', discount: '', price: 20 },
    { img: img2, title: 'Weave (Long)', discount: '', price: 35 },
    { img: img3, title: 'Comb Set', discount: '', price: 20 },

    { img: img1, title: 'Spiral (Partial)', discount: '', price: 25 },
    { img: img2, title: 'Weave', discount: '', price: 40 },
    { img: img3, title: ' Comb', discount: '', price: 20 },
